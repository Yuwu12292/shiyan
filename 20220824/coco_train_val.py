...
def convert_annotations(ann_root, img_root, cls_codebook,sub,create_val_key):
    ...
    print("number of anns : {:}".format(len(ann_nms)))
    if sub == 'train':
...
if __name__ == '__main__': 
        ...
        parser.add_argument('--sub',type=str,default=args['sub']['default'],help='要创建train还是valid')
        ...
        #存traincoco文件
        train_images, train_annotations = convert_annotations(ann_root, img_root, cls_codebook, sub,create_val_key)
        coco_ann = {
            'images' : train_images, 
        ...
        #存validcoco文件
        valid_images, valid_annotations = convert_annotations(ann_root, img_root, cls_codebook, sub,create_val_key)
        coco_ann = {
            'images' : valid_images, 
        ...
        print("len(coco_ann['images'])",len(coco_ann['images']))